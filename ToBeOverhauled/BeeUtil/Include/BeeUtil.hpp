...
#   define BEE_DXGI_THROW_IF_FAIL(x)                                                    \
    {                                                                                   \
        ...
        if (BEE_WIN_FAILED(_dxgiHresultReturn))                                         \
        {                                                                               \
...
#   define B_REPORT_FAILURE() BEE_LOG(BEE_LOG_SEV_ERROR, L"Bee failed at line %d in file '%S'", __LINE__, __FILE__);

#   define B_WIN_REPORT_FAILURE()                                               \
    BEE_LOG(BEE_LOG_SEV_ERROR,                                                  \
            L"Windows failed. GetLastError = %lu at line %d in file '%S'",      \
            GetLastError(),                                                     \
            __LINE__,                                                           \
            __FILE__);                                                          \

#   define B_DXGI_REPORT_E(x)                                           \
    BEE_LOG(BEE_LOG_SEV_ERROR,                                          \
            L"DXGI failed. Error code = %x at line %d in file '%S'",    \
            x,                                                          \
            __LINE__,                                                   \
            __FILE__);                                                  \
